...
public class AdderVersion2 {
    ...
    public static void main(String[] args) {
        //decalre sum and initialize to 0
        int sum =0;
        int operand1 = 0;
        int operand2 = 0;
        
        //decalre and initialize a Scanner object - the Scanner reads
        ...
        //now wait until the user types sometihng in - put the value
        //in stringOperand1
...
//assing the sum of operand1 and operand2 to sum
