...
public class MoreBucketsMoreFun {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("But still " +bugs+ " bugs left, wait a minuete!!!");
        System.out.println("Maybe I just counted wrong the first time...");
        
     // We are using the decrement operater to show the dog ate a butterfly
      // bugs is still using the original value for butterflies         
    }
