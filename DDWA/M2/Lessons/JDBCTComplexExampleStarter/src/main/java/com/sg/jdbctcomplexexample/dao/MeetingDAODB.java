...
public class MeetingDAODB implements MeetingDao {
    ...
    //Meeting is the most complicated class because it is the managed relationip
    //with both Room and Employee
    @Autowired
    JdbcTemplate jdbc;
    ...
    public void updateMeeting(Meeting meeting) {
        ...
        //using helper method to reinsert all the employees not associated with the meeting
        insertMeetingEmployee(meeting);
    }
    ...
    public static final class MeetingMapper implements RowMapper<Meeting>{
        ...
        public Meeting mapRow(ResultSet rs, int index) throws SQLException {
            ...
            //need to add local date, to bring time into it
